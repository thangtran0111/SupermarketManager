...
public class DeliveryReceiptDAO implements DeliveryReceiptDAOInterface {
    ...
    public List<DeliveryReceipt> read() {
        try {
            ...
            while (resultSet.next()) {
                DeliveryReceipt deliveryReceipt = new DeliveryReceipt(resultSet.getString("DeliveryReceiptID").trim(), resultSet.getDate("DeliveryDate"), resultSet.getString("DeliveryStatus").trim(), resultSet.getInt("DeliveryFee"), resultSet.getString("OrderID").trim(), resultSet.getString("DeliveryEmployeeID").trim());
    ...
    public DeliveryReceipt getByDeliveryReceiptID(String deliveryReceiptID) {
        try {
            ...
            if (resultSet.next()) {
                deliveryReceipt = new DeliveryReceipt(resultSet.getString("DeliveryReceiptID").trim(), resultSet.getDate("DeliveryDate"), resultSet.getString("DeliveryStatus").trim(), resultSet.getInt("DeliveryFee"), resultSet.getString("OrderID").trim(), resultSet.getString("DeliveryEmployeeID").trim());
            }
